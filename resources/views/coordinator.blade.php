...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <span class="d-none d-lg-block" style="font-size: 21px;">University Malaysia Pahang</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/searchpsmtitle">
        <i class="bi bi-table"></i>
          <span>PSM Title List</span>
        </a>
      </li><!-- End Psm title list Page Nav -->

      <li class="nav-item">
        <a class="nav-link collapsed" href="/searchstudent">
        <i class="bi bi-person"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/searchsvlist">
        <i class="bi bi-person-check"></i>
          <span>Supervisor's Profile</span>
        </a>
